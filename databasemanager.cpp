...
void DatabaseManager::enregistrerLivre(const QString &titre, const QString &genre, const QString &auteur, const QString &maison_edition, const QString &proprietes, int quantite, const QString &armoire, const QString &identifiant, const QString &date){
    ...
    QSqlQuery query(db);
    query.prepare("INSERT OR IGNORE INTO livres(titre, genre, auteur, maison_edition, proprietes, quantite, armoire, identifiant, date_insertion) VALUES(?,?,?,?,?,?,?,?,?)");
